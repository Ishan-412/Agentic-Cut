...
Please create a step-by-step editing plan."""
    ...
    llm = _get_llm(api_key, state.get("model_name", "gemini-flash-latest"))
    response = llm.invoke([
...
def build_graph(api_key: str, model_name: str = "gemini-flash-latest", quality: str = "high") -> StateGraph:
