...
def _get_llm(api_key: str, model_name: str = "gemini-3.5-flash") -> ChatGoogleGenerativeAI:
...
Please create a step-by-step editing plan."""
    ...
    llm = _get_llm(api_key, state.get("model_name", "gemini-3.5-flash"))
    response = llm.invoke([
...
def build_graph(api_key: str, model_name: str = "gemini-3.5-flash", quality: str = "high") -> StateGraph:
